...
const NavLink = ({ href, children, className }: NavLinkProps) => (
  <Link
    href={href}
    className={cn(
      "text-black text-xl font-semibold font-['Plus_Jakarta_Sans']",
      className
    )}
  >
    {children}
  ...
  return (
    <nav className="w-full px-6 py-4 bg-white shadow-sm border-b border-black/10 flex justify-between items-center">
      ...
      <div className="flex items-center gap-3">
        ...
        />
        <span className="text-xl font-semibold font-['Plus_Jakarta_Sans'] text-black">
          Winston
        </span>
      </div>
      ...
      <div className="flex items-center justify-between gap-8">
        <div className="text-2xl font-bold"> Come join Winston!</div>
