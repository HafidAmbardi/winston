...
interface AggregatedMaterialComponentProps {
  materialId: string;
}

export default function AggregatedMaterialComponent({
  materialId,
}: AggregatedMaterialComponentProps) {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6">
      ...
      <div className="lg:w-2/3">
        {/* Title */}
        <h1 className="text-2xl font-bold mb-1">{aggregatedMaterial.title}</h1>
        <p className="text-gray-600 mb-4">
          {aggregatedMaterial.category} • {aggregatedMaterial.difficulty}
        </p>
        ...
        {detailedMaterials.length === 0 && (
          <div className="bg-yellow-50 border border-yellow-200 text-yellow-700 p-6 rounded-lg mb-6">
            <h2 className="text-xl font-bold mb-2">Tidak ada materi detail</h2>
            <p>
              Paket ini belum memiliki materi detail. Silakan coba paket lain
